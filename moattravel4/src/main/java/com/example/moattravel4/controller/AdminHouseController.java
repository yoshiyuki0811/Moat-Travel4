...
import com.example.moattravel4.form.HouseEditForm;
import com.example.moattravel4.form.HouseRegisterForm;
import com.example.moattravel4.repository.HouseRepository;
import com.example.moattravel4.service.HouseService;
...
public class AdminHouseController {
	...
	public String edit(@PathVariable(name = "id") Integer id, Model model) {
		...
		model.addAttribute(houseEditForm);
